...
### Added
- Added a `FloatingImage` field to all pages that have a Hero.

### Changed
- Bumped project version to 0.1.26 in `package.json`.


## [0.1.25] - 2025-07-21

### Added
- Added a `BackgroundAlignment` field to the `List Topics` component.

### Changed
- Bumped project version to 0.1.25 in `package.json`.

## [0.1.24] - 2025-07-21

### Added
- Added a `CTA` component field to the `Text Block` component.
- Introduced the `Button` single component for reusable call-to-action elements.

### Changed
- Added a relation field to the `Topic` component, allowing it to link to a `Service`.
- Bumped project version to 0.1.24 in `package.json`.

## [0.1.23] - 2025-07-16

### Added
- Added a `TextSwap` field to the `Home` page.
- Updated TypeScript type definitions to include the new components.

### Changed
- Bumped project version to 0.1.23 in `package.json`.

## [0.1.22] - 2025-07-15

### Added
- Introduced new `Case Studies` component for displaying a collection of individual case studies.
- Created the `Case Study` single component with fields for a title, summary, image, and link.
- Updated TypeScript type definitions to include the new components.

### Changed
- Bumped project version to 0.1.22 in `package.json`.
